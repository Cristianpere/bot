...
mongourl = 'mongodb+srv://dragonballxd:cuenta123@cluster0.r7jirmm.mongodb.net/?retryWrites=true&w=majority'
client = pymongo.MongoClient(mongourl,serverSelectionTimeoutMS=5000)
maindb = client.bot['main']

antidb = redis.Redis(host='redis-10114.c276.us-east-1-2.ec2.cloud.redislabs.com', port=10114, password='e0ku4bvwJPKhmTraCTwprqssMIAslmFZ')
